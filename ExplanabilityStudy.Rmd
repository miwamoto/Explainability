...
```{r}
orFair <-       lm(rFair ~ firstContext, data = dc)
orAcc <-        lm(rAcc ~ firstContext, data = dc)
orSat <-        lm(rSat ~ firstContext, data = dc)
orUseful <-     lm(rUseful ~ firstContext, data = dc)
orClear <-      lm(rClear ~ firstContext, data = dc)
orMeaningful <- lm(rMeaningful ~ firstContext, data = dc)
