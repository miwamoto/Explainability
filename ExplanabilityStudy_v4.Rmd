...
dc[, tOther1 := rowSums(dt[,c('tcOther1', 'ttOther1')], na.rm=T)]
dc[, tOther2 := rowSums(dt[,c('tcOther2', 'ttOther2')], na.rm=T)]
dc[, tOther3 := rowSums(dt[,c('tcOther3', 'ttOther3')], na.rm=T)]
#dc[, tOther4 := rowSums(dt[,c('tcOther4', 'ttOther4')], na.rm=T)]

dc[, rOther1 := rowSums(dt[,c('rcOther1', 'rtOther1')], na.rm=T)]
dc[, rOther2 := rowSums(dt[,c('rcOther2', 'rtOther2')], na.rm=T)]
dc[, rOther3 := rowSums(dt[,c('rcOther3', 'rtOther3')], na.rm=T)]
...
```{r}
tcsumother1<-sum(dt$tcOther1, na.rm=TRUE)
#tcsumother1
tcsumother2<-sum(dt$tcOther2, na.rm=TRUE)
#tcsumother2
tcsumother3<-sum(dt$tcOther3, na.rm=TRUE)
#tcsumother3

ttsumother1<-sum(dt$ttOther1, na.rm=TRUE)
#ttsumother1
ttsumother2<-sum(dt$ttOther2, na.rm=TRUE)
#ttsumother2
ttsumother3<-sum(dt$ttOther3, na.rm=TRUE)
#ttsumother3

rcsumother1<-sum(dt$rcOther1, na.rm=TRUE)
rcsumother2<-sum(dt$rcOther2, na.rm=TRUE)
rcsumother3<-sum(dt$rcOther3, na.rm=TRUE)

rtsumother1<-sum(dt$rtOther1, na.rm=TRUE)
rtsumother2<-sum(dt$rtOther2, na.rm=TRUE)
rtsumother3<-sum(dt$rtOther3, na.rm=TRUE)


Number <- c("Other examples","Relative importance","Algorithm detail")
tc <- c(tcsumother1,tcsumother2,tcsumother3)
tt <- c(ttsumother1,ttsumother2,ttsumother3)
rc <- c(rcsumother1,rcsumother2,rcsumother3)
rt <- c(rtsumother1,rtsumother2,rtsumother3)
