...
```{r}
# For the Twitter fairness question, nobody selected value 1, so it created some weirdness with the factors
# The -4 accounts for a shift between value and factor
